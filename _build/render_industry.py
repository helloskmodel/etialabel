...
.wc2col .wccatimg{margin:0;width:100%;height:180px;object-fit:cover;aspect-ratio:auto}
...
@media(max-width:760px){.wc2col{grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}.wc2col .wccatimg{height:150px}.wccatcard{padding:12px 13px}.wccatcard .wccatintro{font-size:12.5px;line-height:1.48}#wcpanel .wcmcards,#wcpanel .wcmcards.wcone{grid-template-columns:1fr}}
...
def main():
    ...
    for slug in ["wire-cable", "outdoor-energy", "pcb", "steel", "automotive", "heat-resistant", "low-temperature", "flame-retardant", "weather-resistant"]:
