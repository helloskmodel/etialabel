...
.wc2col{display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:stretch;max-width:720px;margin:0 auto 16px}
.wc2col .wccatimg{margin:0;width:100%;height:100%;min-height:150px;max-height:210px;aspect-ratio:auto}
...
@media(max-width:760px){.wc2col{grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}.wc2col .wccatimg{min-height:118px;max-height:168px}.wccatcard{padding:12px 13px}.wccatcard .wccatintro{font-size:12.5px;line-height:1.48}#wcpanel .wcmcards,#wcpanel .wcmcards.wcone{grid-template-columns:1fr}}
