...
ENVIRONMENTS = [
 ("heat-resistant", IC_HEAT, "Heat Resistant", "耐高温",
  ...
  [("/products/polyimide-label-materials/", "Polyimide label materials", "聚酰亚胺标签材料"),
   ("/industries/pcb-electronics-labeling-solutions/", "PCB labeling solutions", "PCB 标签解决方案")]),
 ("cold-temperatures", IC_COLD, "Cold Temperatures", "低温",
  ...
  [("/industries/automotive-labeling-solutions/", "Automotive labeling solutions", "汽车标签解决方案"),
